...
Si tenemos acceso a un usuario con permisos `sudo` sobre algún binario, podemos escalar privilegios.
...
La página [**GTFOBins**](https://gtfobins.github.io/) muestra comandos para escalar privilegios mediante binarios específicos.
