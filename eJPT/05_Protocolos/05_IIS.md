...
IIS (Internet Information Services) ejecuta páginas ASPX. Si podemos subir un archivo ASPX, podemos ejecutar comandos. También se pueden subir archivos con extensiones `.aspx`, `.html`, `.php` o `.bat`.
