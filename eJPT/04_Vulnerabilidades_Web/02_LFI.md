...
LFI permite leer archivos locales del servidor web mediante la manipulación de rutas en parámetros de URL.
...
Navegación hacia atrás en el sistema de archivos para leer archivos sensibles:

```
http://example.com/index.php?page=../../../../etc/passwd
```

> La cantidad de `../` depende de la profundidad del directorio donde corre la aplicación.
