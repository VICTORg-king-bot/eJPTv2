...
El módulo `multi/handler` recibe conexiones de payloads generados con msfvenom.
...
Vulnerabilidad crítica en SMBv1 de Windows, usada por ransomware como WannaCry.
...
Versión de vsftpd con backdoor conocido en el puerto 21.
...
Una vez tenemos una sesión de meterpreter, podemos buscar exploits de escalada de privilegios.
