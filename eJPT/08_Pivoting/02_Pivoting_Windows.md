...
Cuando la maquina intermediaria es Windows, usamos modulos de Metasploit para el pivoting.
...
Redirige un puerto de la maquina interna a la maquina Windows (intermediaria). Esto permite acceder al servicio desde nuestra maquina usando la IP de Windows.
...
> Ahora podemos acceder al servicio web interno visitando `http://<IP_windows>:5000` desde nuestra maquina atacante.
