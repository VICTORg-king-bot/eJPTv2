...
Las contraseñas suelen estar al final de `rockyou.txt`. Invertir el orden ahorra tiempo.
...
Algunas contraseñas tienen espacios que pueden causar errores.
...
Cuando el servicio está detrás de un pivoting, se ataca contra localhost en el puerto redirigido.
